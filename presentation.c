...
int main()
{
    ...
    {
        system("cls");
        printf("\t\t====== Assalamualaikum Every One=========\n");
        printf("\t\t====== Student Management Database System ======\n");
        printf("\t\t====== Green Univercity of Bangladesh ======\n");
        printf("\t\t====== Department oF CSE==DC==213===========\n");
        printf("\t\t=== Our course teacher Sultanul Islam Ovi==\n");
        ...
        case '5':
            ...
            break;
        case '0':
            printf("\n\t\t\t====== Thank You So Much dear visitor ======");
            break;
        default:
...
void updateInfo()
{
    FILE *fileOne = fopen("studentInfo.bin", "rb");//rb= reading mode with +
    FILE *temp = fopen("temp.bin", "wb");

    Student studentInformation, tempInformation;//constant character
